...
struct Output_t* 	Output_Create		(bool IsNULL, bool IsSTDOUT, bool IsESOut, bool IsCompress, u32 OutputLineFlush, u64 Output_TimeFlush, u64 Output_ByteFlush, s32* Output_CPUMap);
